    ...
    <>
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          tabBarActiveTintColor: "#0CBACE",
          tabBarInactiveTintColor: "#9CA3AF",
          tabBarStyle: { height: responsiveHeight(8), paddingBottom: responsiveHeight(0.8) },
          tabBarLabelStyle: { fontSize: responsiveFontSize(1.5), marginTop: responsiveHeight(0.3) },
          tabBarIcon: ({ color }) => {
            let iconName;
            switch (route.name) {
              case "Home": iconName = "home"; break;
              case "SlotBooking": iconName = "calendar"; break;
              case "Earnings": iconName = "wallet"; break;
              case "Alerts": iconName = "notifications"; break;
              case "Profile": iconName = "person"; break;
            }
            return <Ionicons name={iconName} size={responsiveFontSize(4)} color={color} />;
          },
        })}
      >
        <Tab.Screen name="Home" component={HomeNavigator} />
