...
export default function WalletScreen({ navigation }) {
  ...
  console.log("SETTLEMENTS: ", settlementList);
              ...
              <>
                <View style={styles.infoItem}>
                  ...
                  <Text style={styles.infoValue}>
                    {formatCurrency(wallet?.todayEarning)}
                  </Text>
                </View>
                ...
                <View style={styles.settlementListContainer} key={index}>
                  ...
                  {settlement.riderType === 'ZESTBOT_EMPLOYEE' ? (
                    <>
                      ...
                      <Row title="Tips" value={item.tips} styles={styles} />
                      <Row
                        title="TDS"
                        value={`- ${formatCurrency(item.tds)}`}
                        negative
                        styles={styles}
                      />
                    ...
                    <>
                      <Row title="Gross Earnings" value={item.grossEarnings} styles={styles} />
                      <Row title="Incentives" value={item.incentiveAmount} styles={styles} />
                      <Row title="Tips" value={item.tipsAmount} styles={styles} />
                      <Row
                        title="TDS"
                        value={`- ${formatCurrency(item.tdsAmount)}`}
                        negative
                        styles={styles}
                      />
                      <View style={styles.netBox}>
...
// ─── Row components ──────────────────────────────────────────────────────────
const Row = ({ title, value, negative, styles }) => (
...
const createStyles = isTablet =>
  StyleSheet.create({
    ...
    header: {
      ...
      paddingHorizontal: isTablet ? 32 : rw(4),
      paddingVertical: isTablet ? 20 : rh(2.2),
      marginBottom: isTablet ? 0 : 9,
      backgroundColor: '#FFFFFF',
      elevation: 3
    },
    headerTitle: {
      fontSize: isTablet ? 24 : rf(2.3),
      fontWeight: '700',
      color: '#101828'
    },
    walletContainer: {
    ...
    walletAmount: {
      ...
      fontWeight: '600',
      marginTop: isTablet ? 18 : 13,
    },
    infoCard: {
      marginHorizontal: isTablet ? 28 : 20,
      marginTop: isTablet ? -80 : -65,
      backgroundColor: '#fff',
    ...
    statementBtn: {
      ...
      height: isTablet ? 58 : 45,
      backgroundColor: '#162D68',
      borderRadius: isTablet ? 16 : 13.5,
      flexDirection: 'row',
      justifyContent: 'center',
      alignItems: 'center',
    },
